var conf = {
    ...
    roadmap : {
        ...
        path : [
            ...
            //==========================================
            {
                reg : /\/page\/(.*)\/((?:pdcbase|pdcextend)\.js)$/i,
                useOptimizer:false,
                isMod:false,
                release : false
            },
    ...
    'deploy':{
		...
		db284:[{
            ...
            //这个参数会跟随post请求一起发送
            to : '/home/video/explore-odp/webroot/browse_static/',
            //支持对文件进行字符串替换
            replace : {
                from : /\/static\/v3\//g,
                to :function(){return '/browse_static/v3/'}
            ...
            //保存到远端机器的/home/fis/www/static目录下
            //这个参数会跟随post请求一起发送
            to : '/home/video/explore-odp/template/browse_template_v3',
            //支持对文件进行字符串替换
            replace : {
                from : /\/static\/v3\//g,
                to :function(){return '/browse_static/v3/'}
		...
		//王兴龙测试机
		wxl: [{
            receiver: 'http://cp01-rdqa-pool642.cp01.baidu.com:8001/receiver.php',
			from: '/static',
            subOnly: true,
            to : '/home/users/wangxinglong/odp/webroot/browse_static/',
            replace: {
                from: /\/static\/v3\//g,
                to: function() {
                    return '/browse_static/v3/'
            ...
            from: '/template',
            subOnly: true,
            to : '/home/users/wangxinglong/odp/template/browse_template_v3',
            replace: {
                from: /\/static\/v3\//g,
                to: function() {
                    return '/browse_static/v3/'
            ...
            to : '/home/users/wangxinglong/odp/template/browse_template_v3/config'
        }],
		//小海测试机
        xiaohai:[{
		...
		//东旭测试机
        dongxu:[{
            receiver : 'http://cp01-rdqa-dev397.cp01.baidu.com:8880/receiver.php',
            from : '/static',
            subOnly : true,
        ...
        zijian: [{
            ...
            from: '/static',
            subOnly: true,
            to: '/home/video/zhouzijian/apache/htdocs/browse_static/',
            replace: {
                from: /\/static\/v3\//g,
                to: function() {
                    return '/browse_static/v3/'
            ...
            from: '/template',
            subOnly: true,
            to: '/home/video/zhouzijian/svn/php-ui/browse_template_v3',
            replace: {
                from: /\/static\/v3\//g,
                to: function() {
                    return '/browse_static/v3/'
            ...
            to: '/home/video/zhouzijian/svn/php-ui/browse_template_v3/config'
        }],
        hanwei: [{
            receiver: 'http://cq01-rdqa-pool121.cq01.baidu.com:8080/receiver.php',
            from: '/static',
            subOnly: true,
