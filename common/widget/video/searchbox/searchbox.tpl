...
<form action="/v" method="get" name="f1" id="{%$id%}" class="bdv-search{%if $style%} bdv-search-{%$style%}" data-style="{%$style%}{%/if%}"{%if ($pageTn != 'videoMultiNeed')%} target="_blank"{%/if%}>
	...
	<span class="bdv-search-btns">
		<input type="submit" value="百度一下" id="{%$id%}Btn" />
	</span>
