...
var conf = {
    ...
    roadmap: {
         ...
         *      - useSprite：指定文件是否进行csssprite处理。默认是 false，即不对单个文件进行csssprite操作的
         *      ，而只对合并后的文件进行。fis release中使用 --pack 参数即可触发csssprite操作。
    ...
    settings: {
        ...
        optimizer: {
            'smarty-xss': {
                ...
                xssSafeVars: [ // 配置白名单，支持正则
                    /(pageTn|pid|id|title|PRE|DOMAIN|url)/
                ]
    ...
    deploy: {
        ...
        // 预览地址:http://cp01-rdqa-pool326.cp01.baidu.com:8123/index/page/home
        zhangnan: [
            {
                receiver: 'http://cp01-rdqa-pool326.cp01.baidu.com:8080/zhangnan/fisreceiver/',
                from: '/',
                subOnly: true,
                to: '/home/video/.fis-plus-tmp/www/',
                exclude: /.*\.(?:svn|cvs|tar|rar|psd).*/
